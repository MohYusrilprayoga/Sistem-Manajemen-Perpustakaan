        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details">
              <h1><strong>Dilan 2 1991</strong></h1>
              <p>
                Pidi Baiq
              </p>
              ...
              <div class="gallery">
                <div class="xzoom-container">
                  <img class="xzoom" id="xzoom-default" src="frontend/images/list2.jpg" xoriginal="frontend/images/list2.jpg" />
                </div>
                <h2>Sinopsis Dilan 1991</h2>
                ...
                <div class="features row">
                  <div class="col-md-4 ">
                    <div class="description">
                      <h3>Address</h3>
                      <p>Jln.Cinambo No.135 Cisaranten Wetan</p>
                    </div>
                  </div>
            ...
            <div class="card card-details card-right rounded-top" style="border-radius: 0;">
              ...
              <table class="trip-informations">
                <tr>
                  ...
                  <td width="50%" class="text-right">Aug, 2015</td>
                </tr>
                <tr>
                  <th width="50%">Type</th>
                  <td width="50%" class="text-right">Romantic</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="50%" class="text-right">Pastel Books</td>
                </tr>
              </table>
            </div>
            <div class="join-container">
              <div class="d-grid gap-2">
                <a href="https://www.perpus.org/romansa/dilan-2-(shabrinabachtiar)" class="btn btn-block btn-join-now mt-3 py-2">Read Now</a>
              </div>
            </div>
          </div>
        </div>
