        ...
        <div class="row">
          <div class="col-lg-8 pl-lg-0">
            <div class="card card-details">
              <h1><strong>Filosofi Teras</strong></h1>
              <p>
                Henry Manampiring
              </p>
              ...
              <div class="gallery">
                <div class="xzoom-container">
                  <img class="xzoom" id="xzoom-default" src="frontend/images/list4.jpg" xoriginal="frontend/images/list4.jpg" />
                </div>
                <h2>Sinposis Filosofi Teras</h2>
                ...
                <div class="features row">
                  <div class="col-md-4 ">
                    <div class="description">
                      <h3>Address</h3>
                      <p>Jl. Palmerah Selatan, Jakarta</p>
                    </div>
                  </div>
          ...
          <div class="col-lg-4">
            <div class="card card-details card-right rounded-top" style="border-radius: 0;">
              ...
              <tr>
                  ...
                  <td width="50%" class="text-right">Buku Kompas, 2019</td>
                </tr>
                <tr>
                  <th width="50%">Type</th>
                  <td width="50%" class="text-right">Philosophie</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="50%" class="text-right">Buku Kompas</td>
                </tr>
              </table>
            </div>
            <div class="join-container">
              <div class="d-grid gap-2">
                <a href="https://www.perpus.org/pengembangan-diri/filosofi-teras---henry-manampiring" class="btn btn-block btn-join-now mt-3 py-2">Read Now</a>
              </div>
            </div>
          </div>
        </div>
